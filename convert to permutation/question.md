...
- Choose an index `i (1 ≤ i ≤ N)` and increase `Aᵢ` by `1`.
...
- Operation `1`: Choose `i = 3` and increase `A₃` by `1`. Thus, the array becomes `A = [3, 1, 2, 2]`.
- Operation `2`: Choose `i = 3` and increase `A₃` by `1`. Thus, the array becomes `A = [3, 1, 3, 2]`.
- Operation `3`: Choose `i = 3` and increase `A₃` by `1`. Thus, the array becomes `A = [3, 1, 4, 2]`.

It can be shown that this is the minimum number of operations required to convert the array `A` into a permutation.
...
- Operation `1`: Choose `i = 1` and increase `A₁` by `1`. Thus, the array becomes `A = [3, 0, 1]`.
- Operation `2`: Choose `i = 2` and increase `A₂` by `1`. Thus, the array becomes `A = [3, 1, 1]`.
- Operation `3`: Choose `i = 3` and increase `A₃` by `1`. Thus, the array becomes `A = [3, 1, 2]`.

It can be shown that this is the minimum number of operations required to convert the array `A` into a permutation. :contentReference[oaicite:0]{index=0}
