...
1. Delete any one character from `S`, and concatenate the remaining parts of the string. For example, if we delete the third character of `S = 1101`, it becomes `S = 111`.
2. Flip all the characters of `S`. For example, if we flip all character of `S = 1101`, it becomes `S = 0010`.
...
Note that we have obtained a string having all characters as `0`. It can be shown that this is the minimum number of operations required.
